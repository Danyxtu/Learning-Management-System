...
function init() {
  ...
  if (calendarDays && currentMonthElem) {
    ...
    console.error(
      'Calendar elements not found. Make sure calendarDays and currentMonthElem exist in the DOM.'
    );
  }
}
  ...
  if (confirmJoinBtn && joinClassModal) {
    confirmJoinBtn.addEventListener('click', () => {
      ...
      if (isValidClassCode(classCode)) {
        ...
        alert(
          'Please enter a valid class code (5-7 letters or numbers, no spaces or symbols)'
        );
      }
    });
  }
